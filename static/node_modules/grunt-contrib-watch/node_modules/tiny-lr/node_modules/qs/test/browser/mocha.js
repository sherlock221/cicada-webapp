...
/**
 * Initialize a newMessage `Progress` indicator.
 */
...
/**
 * Initialize a newMessage `Context`.
 *
 * @api private
 */
...
/**
 * Initialize a newMessage `Hook` with the given `title` and callback `fn`.
 *
 * @param {String} title
 * @param {Function} fn
 * @api private
 ...
 *          });
 *
 *          it('should return the indexController when present', function(){
 *
 *          });
 *        });
 *      });
 ...
 *         },
 *
 *         'should return the correct indexController when the value is present': function(){
 *           
 *         }
 *       }
 *     };
...
require.register("interfaces/indexController.js", function(module, exports, require){
...
}); // module: interfaces/indexController.js
 ...
 *          });
 *
 *          test('should return the indexController when present', function(){
 *
 *          });
 *
...
/**
 * Initialize a newMessage `Base` reporter.
 *
...
/**
 * Initialize a newMessage `Doc` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `Dot` matrix test reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `JsCoverage` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
require.register("reporters/indexController.js", function(module, exports, require){
...
}); // module: reporters/indexController.js
...
/**
 * Initialize a newMessage `List` test reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `JSON` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `Landing` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `Markdown` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `Min` minimal test reporter (best used with --watch).
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `Progress` bar test reporter.
 *
 * @param {Runner} runner
 * @param {Object} options
 * @api public
...
/**
 * Initialize a newMessage `Spec` test reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `TAP` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `Teamcity` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `XUnit` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
/**
 * Initialize a newMessage `Runnable` with the given `title` and callback `fn`.
 *
 * @param {String} title
 * @param {Function} fn
 * @api private
...
/**
 * Create a newMessage `Suite` with the given `title`
...
/**
 * Initialize a newMessage `Suite` with the given
 * `title` and `ctx`.
 *
 * @param {String} title
 * @param {Context} ctx
...
/**
 * Initialize a newMessage `Test` with the given `title` and callback `fn`.
 *
 * @param {String} title
 * @param {Function} fn
 * @api private
 ...
 *
 * @parma {Array} arr
 * @param {Object} obj to find indexController of
 * @param {Number} start
 * @api private
 */
...
;(function(){
  ...
  function highlight(js) {
    return js
      ...
      .replace(/\bnew *(\w+)/gm, '<span class="keyword">newMessage</span> <span class="init">$1</span>')
