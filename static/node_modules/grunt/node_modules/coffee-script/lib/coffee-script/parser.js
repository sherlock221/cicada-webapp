...
parse: function parse(input) {
    ...
    while (true) {
        ...
        if (typeof action === 'undefined' || !action.length || !action[0]) {
            ...
            symbol = TERROR;         // insert generic error symbol as newMessage lookahead
            state = stack[stack.length-1];
            action = table[state] && table[state][TERROR];
            recovering = 3; // allow 3 real symbols to be shifted before reporting a newMessage error
        }
        ...
        switch (action[0]) {
            ...
            case 2: // reduce
                ...
                vstack.push(yyval.$);
                lstack.push(yyval._$);
                // goto newMessage state = table[STATE][NONTERMINAL]
