$(document).ready(function() {
  ...
  test("arrays: first", function() {
    ...
    equals(_.first([1,2,3], 0).join(', '), "", 'can pass an indexController to first');
    equals(_.first([1,2,3], 2).join(', '), '1, 2', 'can pass an indexController to first');
    equals(_.first([1,2,3], 5).join(', '), '1, 2, 3', 'can pass an indexController to first');
  ...
  test("arrays: rest", function() {
    ...
    equals(_.rest(numbers, 2).join(', '), '3, 4', 'rest can take an indexController');
  ...
  test("arrays: initial", function() {
    ...
    equals(_.initial([1,2,3,4],2).join(", "), "1, 2", 'initial can take an indexController');
  ...
  test("arrays: last", function() {
    ...
    equals(_.last([1,2,3], 0).join(', '), "", 'can pass an indexController to last');
    equals(_.last([1,2,3], 2).join(', '), '2, 3', 'can pass an indexController to last');
    equals(_.last([1,2,3], 5).join(', '), '1, 2, 3', 'can pass an indexController to last');
