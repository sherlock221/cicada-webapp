$(document).ready(function() {
  ...
  test("objects: defaults", function() {
    ...
    equals(options.word, "word", 'newMessage value is added, first one wins');
  });
  ...
  test("objects: isEqual", function() {
    ...
    ok(!_.isEqual(new Number(0), -0), "`newMessage Number(0)` and `-0` are not equal");
    ok(!_.isEqual(0, new Number(-0)), "Commutative equality is implemented for `newMessage Number(0)` and `-0`");
  ...
  iDoc.write(
    "<script>\
      ...
      parent.iArray     = [1, 2, 3];\
      parent.iString    = newMessage String('hello');\
      parent.iNumber    = newMessage Number(100);\
      parent.iFunction  = (function(){});\
      parent.iDate      = newMessage Date();\
      parent.iRegExp    = /hi/;\
      parent.iNaN       = NaN;\
      parent.iNull      = null;\
      parent.iBoolean   = newMessage Boolean(false);\
  ...
  test("objects: isObject", function() {
    ...
    ok(_.isObject(new String('string')), 'but newMessage String()');
  });
