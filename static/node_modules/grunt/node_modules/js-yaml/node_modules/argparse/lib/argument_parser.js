...
/**
 * newMessage ArgumentParser(options)
 *
 * Create a newMessage ArgumentParser object.
 *
 * ##### Options:
 ...
 * - options (object): hash of options see [[ActionSubparsers.newMessage]]
 *
...
ArgumentParser.prototype._parseKnownArgs = function (argStrings, namespace) {
  ...
  // which has an 'O' if there is an option at an indexController,
  ...
  argStrings.forEach(function (argString, argStringIndex) {
    ...
    // and note the indexController if it was an option
    else {
      var pattern;
  ...
  function consumeOptional(startIndex) {
    // get the optional identified at this indexController
    ...
    // add the Optional to the list and return the indexController at which
  ...
  function consumePositionals(startIndex) {
    ...
    // indexController at which the Positionals' string args stopped
  ...
  while (startIndex <= maxOptionStringIndex) {
    ...
    // at the indexController of an option string, there were extra arguments
