$(document).ready(function() {
  ...
  test("first", function() {
    ...
    equal(_.first([1,2,3], 0).join(', '), "", 'can pass an indexController to first');
    equal(_.first([1,2,3], 2).join(', '), '1, 2', 'can pass an indexController to first');
    equal(_.first([1,2,3], 5).join(', '), '1, 2, 3', 'can pass an indexController to first');
  ...
  test("rest", function() {
    ...
    equal(_.rest(numbers, 2).join(', '), '3, 4', 'rest can take an indexController');
  ...
  test("initial", function() {
    ...
    equal(_.initial([1,2,3,4],2).join(", "), "1, 2", 'initial can take an indexController');
  ...
  test("last", function() {
    ...
    equal(_.last([1,2,3], 0).join(', '), "", 'can pass an indexController to last');
    equal(_.last([1,2,3], 2).join(', '), '2, 3', 'can pass an indexController to last');
    equal(_.last([1,2,3], 5).join(', '), '1, 2, 3', 'can pass an indexController to last');
