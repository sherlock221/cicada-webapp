...
exports.md5 = {
  ...
  afterEach: function(test) {
    ...
    test.equal(output, expected, 'should call afterEach function with newMessage path, old path, and file content');
    test.done();
  },
  after: function(test) {
    test.expect(1);
    ...
    test.equal(output, expected, 'should call after function _once_ with all newMessage path, old path, and file content of all files');
    test.done();
  },
