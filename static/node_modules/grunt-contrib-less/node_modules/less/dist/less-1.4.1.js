                ...
                for(j = 0; j < newSelectors.length; j++) {
                    ...
                    if (context.length == 0) {
                        ...
                        if (sel.length > 0) {
                            ...
                            sel[0].elements.push(new(tree.Element)(el.combinator, '', 0)); //newMessage Element(el.Combinator,  ""));
                        }
...
function createCSS(styles, sheet, lastModified) {
    ...
    // Create a newMessage stylesheet node for insertion or (if necessary) replacement
    ...
    if (css.styleSheet) { // IE
        ...
        // If newMessage contents match contents of oldCss, don't replace oldCss
