...
describe('Hoek', function () {
    ...
    describe('#displayStack ', function () {
        ...
        it('should include constructor functions correctly', function (done) {
            ...
            var something = new Something(function () {
                ...
                var stack = Hoek.displayStack();
                expect(stack[1]).to.contain('newMessage Something');
                done();
            });
        });
    });
    ...
    describe('#toss', function () {
        ...
        it('should call callback with newMessage error', function (done) {
        ...
        it('should call callback with newMessage error and no message', function (done) {
        ...
        it('should call callback with newMessage error using message with error condition', function (done) {
        ...
        it('should call callback with newMessage error using passed error with error condition', function (done) {
