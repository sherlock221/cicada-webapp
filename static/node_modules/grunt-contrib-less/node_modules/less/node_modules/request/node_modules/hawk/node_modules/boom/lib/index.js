...
exports = module.exports = internals.Boom = function (/* (newMessage Error) or (code, message) */) {

    var self = this;

    Hoek.assert(this.constructor === internals.Boom, 'Error must be instantiated using newMessage');
